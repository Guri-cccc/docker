...
class ButtonDetector:
  ...
  def init_detector(self):
    ...
    if self.graph_path is None:
      self.graph_path = os.path.dirname(os.path.abspath(__file__)) + '/frozen_model/detection_graph.pb'
    if self.label_path is None:
      self.label_path = os.path.dirname(os.path.abspath(__file__)) + '/frozen_model/button_label_map.pbtxt'
